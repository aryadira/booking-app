...
test.beforeEach(async ({ page }) => {
  ...
  await page.locator("[name=password]").fill("password5");
...
test("should allow user to add a hotel", async ({ page }) => {
  ...
  await page.setInputFiles('[name="imageFiles"]', [path.join(__dirname, "files", "1.png"), path.join(__dirname, "files", "2.png")]);
